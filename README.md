...
скорость каждой площадки. Поверх этого — мультипользовательский доступ с тарифами, батч‑анализ
...
- **Батч‑анализ:** сравнение сразу по многим направлениям одним запуском — в фоне, с прогрессом
  и уведомлением по готовности (ЛК «Мои анализы»).
