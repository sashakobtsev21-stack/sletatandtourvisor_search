...
const BENEFITS = [
  ...
  { icon: Globe2, title: "Мультипоиск по направлениям",
    text: "Запустите сравнение сразу по десяткам стран — мультипоиск идёт в фоне, по готовности приходит уведомление." },
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <GlassCard initial="hidden" whileInView="show" viewport={{ once: true }} variants={fadeUp} className="flex flex-col p-6 ring-1 ring-brand/30">
              ...
              <ul className="mt-4 space-y-2 text-sm text-muted">
                ...
                <Li>Мультипоиск по направлениям</Li>
